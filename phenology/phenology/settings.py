"""
Django settings for phenology project.
...
# AWS Configuration (for future integrations)
...
DATA_COLLECTION_SERVICE_URL = os.getenv('DATA_COLLECTION_SERVICE_URL', 'http://localhost:8000')
